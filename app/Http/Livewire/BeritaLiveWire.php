...
class BeritaLiveWire extends Component
{
    ...
    public $id_berita, $id_sub_kategori, $id_users, $judul_berita, $sub_judul_berita, $short_desc_berita , $isi_berita, $foto_berita, $lokasi_berita, $jumlah_berita_dibaca, $created_at, $updated_ed;
    public function render()
    {
        ...
        return view('livewire.berita-live-wire')
        ->extends('template')
        ->section('content');
