        ...
        <table class="table">
            <thead>
              ...
              <tr>
                  ...
                  <td>
                      <button wire:click.prevent="show({{ $row['id_hashtag'] }})" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit">
                          Edit
                        </button>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                @endif
                  <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Nama Hashtag</label>

                      <input type="text" class="form-control" name="nama_hashtag" wire:model="nama_hashtag">

                    </div>

                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Keterangan Hashtag</label>
