<div>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <button wire:click.prevent="show({{ $row['id_kategori'] }})" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit">
                    Edit
                  </button>
        ...
        <div class="modal-body">
          ...
          @endif
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nama_kategori" wire:model="nama_kategori">

              </div>

              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Keterangan Kategori</label>
