...
<html lang="en">
  ...
  <body>
    ...
    <form>
        <div class="mb-3">
          <label for="form-label">Nama Hashtag</label>
          <input type="text" nama="nama_hashtag" class="form-control">
        </div>

        <div class="mb-3">
            <label for="form-label">Keterangan Hashtag</label>
            <input type="text" nama="keterangan_hashtag" class="form-control">
          </div>
