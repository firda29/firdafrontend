  ...
  <body>
    ...
    <form>
        <div class="mb-3">
          ...
          <input type="text" nama="nama" class="form-control">
        </div>

        <div class="mb-3">
            <label for="form-label">Telepon</label>
            <input type="number" nama="telepon" class="form-control">
          </div>

          <div class="mb-3">
            <label for="form-label">Email</label>
            <input type="email" nama="email" class="form-control">
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="file" nama="foto_users" class="form-control">
          </div>

          <div class="mb-3">
            <label for="form-label">Level Users</label>
            <input type="number" nama="level_users" class="form-control">
          </div>
